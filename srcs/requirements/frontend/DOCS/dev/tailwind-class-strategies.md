...
<template>
  <div class="flex h-[calc(100vh-60px)]">
    <aside class="w-64 shrink-0 bg-surface-50 ...">
      <slot name="sidebar" />
    </aside>
...
<!-- Usage -->
<SidebarLayout>
  <template #sidebar>Navigation here</template>
  Main content here
</SidebarLayout>
```

**Verdict:** Winner for layouts. Your view should care about *what* to show, not *how wide* the sidebar is.
