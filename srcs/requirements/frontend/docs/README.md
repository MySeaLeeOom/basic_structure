...
| File | Description |
|------|-------------|
| [ws-notification-channel.md](dev/plans/ws-notification-channel.md) | **Real-time sidebar updates.** Dedicated WebSocket on notes service for cross-user title changes, note creation/deletion. REST + WS endpoint spec, data flow diagrams, implementation checklist. |
